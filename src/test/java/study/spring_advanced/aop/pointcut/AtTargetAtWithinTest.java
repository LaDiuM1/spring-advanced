...
public class AtTargetAtWithinTest {
    ...
    static class AtTargetAtWithinAspect {
        ...
        @Around("execution(* study.spring_advanced.aop..*(..)) " +
                "&& @target(study.spring_advanced.aop.config.annotation.ClassAop)")
        ...
        @Around("execution(* study.spring_advanced.aop..*(..)) " +
                "&& @within(study.spring_advanced.aop.config.annotation.ClassAop)")
